...
const ThemeToggler = () => {
  ...
  return (
    <div
      onClick={handleClick}
      className='bg-contrast-dark cursor-pointer fixed left-0 bottom-0 w-10 h-10 rounded-full flex items-center justify-center z-50 dark:bg-secondaryvariant-dark m-1'
    >
